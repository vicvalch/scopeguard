...
type VerifierPolicyRow = {
  id: string;
  allowed_trust_domain_id: string;
  allowed_issuer_app: string;
  allowed_actions: string[] | null;
  allowed_resource_types: string[] | null;
};
