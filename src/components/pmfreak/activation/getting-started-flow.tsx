  ...
  return (
    <main className="space-y-6 pb-10">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        {explainers.map(([t, d]) => <article key={t} className="rounded-2xl border border-white/10 bg-white/25 p-4"><p className="text-sm font-semibold">{t}</p><p className="mt-2 text-xs text-slate-300">{d}</p></article>)}
      </section>
