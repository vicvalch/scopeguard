...
const storageOptions: StorageOption[] = [
  {
    ...
    description:
      "Fastest setup with fully managed operational infrastructure, governance, and encrypted storage.",
  ...
  },
  {
    ...
    description:
      "Keep operational memory stored locally on company-controlled infrastructure and devices.",
  },
  {
    id: "self_hosted",
          ...
          <section className="space-y-7 rounded-3xl border border-cyan-200/20 bg-gradient-to-b from-cyan-400/[0.05] via-white/[0.03] to-transparent p-6 md:p-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
              <p className="text-sm leading-relaxed text-slate-300">
                PMFreak was designed to help organizations retain ownership over their operational intelligence.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-slate-300">
                Project conversations, stakeholder context, timelines, risks, decisions, and institutional memory
                can live inside a dedicated operational vault controlled by your organization.
              </p>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <article className="rounded-2xl border border-cyan-300/30 bg-cyan-400/[0.06] p-5">
              ...
              <div className="mt-4 space-y-2 text-sm text-slate-200">
                <p>
                  <span className="text-slate-400">Company:</span> {form.companyName || "Not provided"}
                </p>
                <p>
                  <span className="text-slate-400">Project:</span> {form.projectName || "Not provided"}
                </p>
                <p>
                  <span className="text-slate-400">Vault strategy:</span>{" "}
                  {storageOptions.find((item) => item.id === form.storageStrategy)?.title}
                </p>
                <p>
                  <span className="text-slate-400">Operational intelligence:</span> {readiness.templateCoverage}% complete
                </p>
              </div>
            </article>
