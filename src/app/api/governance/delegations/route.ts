...
export async function GET(request: Request) {
  ...
  const supabase = createPrivilegedSupabaseClient({ routeId: "/api/governance/delegations", operation: "list_delegations", reason: "governance_view", systemActor: "governance_api", workspaceId, actorUserId: user.id });
